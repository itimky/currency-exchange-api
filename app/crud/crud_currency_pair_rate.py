...
from app.schemas.currency_pair_rate import (
    CurrencyPairRateCreate,
    CurrencyPairRateUpdate,
)


class CRUDCurrencyPairRate(
    CRUDBase[CurrencyPairRate, CurrencyPairRateCreate, CurrencyPairRateUpdate]
):
